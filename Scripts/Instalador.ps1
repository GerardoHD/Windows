curl https://raw.githubusercontent.com/GerardoHD/Windows/master/Scripts/Descargar-Scripts.ps1 -o C:\Program` Files\WindowsPowerShell\Scripts\Descargar-Scripts.ps1
...
rm C:\Program` Files\WindowsPowerShell\Scripts\Instalador.ps1
curl https://raw.githubusercontent.com/GerardoHD/Windows/master/Scripts/Instalador.ps1 -o C:\Program` Files\WindowsPowerShell\Scripts\Instalador
.ps1
echo Ejecutar Uno
